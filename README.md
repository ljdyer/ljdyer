...
<table style="width:100%; text-align:center; border:none; table-layout: fixed">
  ...
  <tr>
    <td align="center" style="width:33%; text-align:center" width="33%"><a href="https://github.com/ljdyer/reference-checker">Reference-checker</a> is a browser based tool for checking list of referenes for University assignments.</td>
